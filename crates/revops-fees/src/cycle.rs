...
use crate::thompson::{dynamics, recompute, sampling, GaussianThompsonState};
...
/// py `ChannelCycleState` dataclass (2227-2292), field defaults verbatim.
#[derive(Debug, Clone, PartialEq)]
...
/// `_serialize_cycle_state_payload` (py 3717-3741): the canonical v2
/// payload shape, key order frozen.
pub fn serialize_cycle_state_payload(s: &ChannelCycleState) -> OValue {
    OValue::obj(vec![
        ...
        (
            ...
            match s.dynamic_htlcmin_baseline_msat {
                Some(v) => OValue::Int(v),
                None => OValue::Null,
            },
        ),
...
/// py `ChannelFeeState` dataclass (2053-2103), field defaults verbatim.
#[derive(Debug, Clone, PartialEq)]
