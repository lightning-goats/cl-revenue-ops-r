...
MATRIX = [
    ...
    ("revenue-boltz-quote", "revenue-r-boltz-quote", ("amount_sats=50000",)),
    ("revenue-boltz-backup", "revenue-r-boltz-backup", ()),
    ("revenue-boltz-backup-verify", None, ()),
    ("revenue-boltz-wallet", "revenue-r-boltz-wallet", ()),
    ("revenue-boltz-expansion-treasury-cycle", None, ()),
    ("revenue-boltz-expansion-treasury-recommendations", "revenue-r-boltz-expansion-treasury-recommendations", ()),
    ("revenue-boltz-expansion-treasury-status", "revenue-r-boltz-expansion-treasury-status", ()),
    ("revenue-boltz-external-pay-ignores", "revenue-r-boltz-external-pay-ignores", ()),
    ("revenue-boltz-balance-recommendations", "revenue-r-boltz-balance-recommendations", ()),
    ("revenue-boltz-auto-cycle-status", "revenue-r-boltz-auto-cycle-status", ()),
